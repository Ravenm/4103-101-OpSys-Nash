...
"""
@Class: Imgur
@Usage: imgur = ImgUr(download_directory_name)
"""
class ImgUr(object):
    """
...
@Params: x {int}: Number of images to download
...
"""
@Function: threaded
@Description:  This function uses a threaded implementation to 
download "x" images from imgur
@Params: x {int}: Number of images to download
